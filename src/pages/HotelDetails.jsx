      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-10">
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 bg-white rounded-xl p-6 shadow-[0_2px_16px_rgba(0,0,0,0.04)] space-y-6">
            <div>
              <p className="text-xs text-muted uppercase tracking-wider mb-1">Price per night</p>
              <p className="text-3xl font-numbers font-semibold text-text">₹{(hotel.price).toLocaleString('en-IN')}</p>
            </div>
